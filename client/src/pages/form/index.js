        ...
        try {
            ...
            if (data.dependents) {
                data.dependents.forEach((dependant, index) => {
                    ...
                    dependentsDetails[GHL_CUSTOM_FIELDS[`${keyPrefix}_gender`]] = `${dependant.gender}`;
                    dependentsDetails[GHL_CUSTOM_FIELDS[`${keyPrefix}_relationship`]] = `${dependant.relationship}`;
                    dependentsDetails[GHL_CUSTOM_FIELDS[`${keyPrefix}_phone`]] = `${dependant.phone}`;
            ...
            let contact = {
                ...
                customField: {
                    ...
                    [GHL_CUSTOM_FIELDS["contact.name_of_employer"]]: data.details.recent_employer,
                    [GHL_CUSTOM_FIELDS["contact.us_national"]]: data.details.us_national === 'true' ? 'Yes' : 'No',
                    [GHL_CUSTOM_FIELDS["contact.tobacco_user"]]: data.details.uses_tobacco === 'true' ? 'Yes' : 'No',
                }
            }
