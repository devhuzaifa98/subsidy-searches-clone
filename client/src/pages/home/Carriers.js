...
const Carriers = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-y-16 py-20 px-10 bg-gray-100 text-5xl font-bold text-center">
...
const StyledImage = ({ src, alt }) => (
  <div className="h-48 w-auto max-w-40 flex justify-center items-center px-5 bg-white py-10">
    <img src={src} alt={alt} />
  </div>
);
