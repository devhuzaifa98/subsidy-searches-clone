    ...
    return (
        <Layout>
            <div className="w-11/12 md:w-2/3 mx-auto pb-10">
                <h2 className="font-semibold text-2xl text-center">Privacy Policy</h2>
                <h4 className="text-red mb-3 text-center">Last Updated: May 2nd, 2024</h4>
                <p>
                    Thank you for your interest in Allied Premium Insurance, LLC. (“we,” “us,” or “our”). This Privacy Policy (“Policy”) applies to the following websites owned and operated by Allied Premium Insurance, LLC, and other websites where we post this document as the applicable Privacy Policy, along with any related websites, networks, applications, insurance agent and representative services, and communication channels (including online chat and telephone call centers), and other services provided by us:
                </p>
                <ul className="text-sm my-3 ml-6 list-disc">
                    <li>
                ...
                <h4 className="text-secondary font-semibold my-3 text-lg">When and why we share personal information</h4>
                <p className="font-semibold">Insurance Companies, Licensed Agents and Business Partners, HSA Trustees or Administrators, and Government-run Exchanges and Entities</p>
                <p>
                ...
                <h4 className="text-secondary font-semibold my-3 text-lg">Service Providers</h4>
                <p>
                    We may disclose your personal information to other companies that help us to process or service any application you begin, process or submit through us, or to correspond with you. For example, we may provide your personal information to a service provider to verify the validity or credit limit of your credit card. Please be assured that the companies we hire to process or service your insurance application or correspond with you are not allowed to use your personal information for their own purposes and are contractually obligated to maintain strict confidentiality. Data obtained through the SMS short code program will not be shared with any third-parties for their marketing reasons/purposes.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">
                    Employers, Affinity Groups, and Benefits Administrators or Consultants
                </h4>
                <p>
                    If you were referred to us by, or use our website or call center in connection with, a current or former employer, affinity group, or other organization with which you may be affiliated (or a benefits administrator or consultant associated with such employer, group or organization), we may disclose your personal information to such employer, group, organization, administrator and/or consultant. For example, we may inform such employer, group, organization, administrator and/or consultant whether or not you have enrolled in a plan. Please be assured that these parties are only allowed to use your personal information as permitted by applicable law.Legal ObligationsIn certain situations, Allied Premium Insurance, LLC may be required to disclose personal data in response to lawful requests by public authorities, including to meet national security or law enforcement requirements.) We may also disclose your personal information as required by law, such as to comply with a subpoena, or similar legal process. We may disclose or report your personal information when we believe, in good faith, that the disclosure is required or permitted under law, for example, to cooperate with regulators or law enforcement authorities, to resolve consumer disputes, to protect our rights, to protect your safety or the safety of others, to investigate fraud, or to otherwise respond to a government request.Business TransitionIf Allied Premium Insurance, LLC is involved in a merger, acquisition, or sale of all or a portion of its assets, you will be notified via email and/or a prominent notice on our website of any change in ownership or uses of your personal information, as well as any choices you may have regarding your personal information.Your ConsentIf you provide us an indication of your consent to disclose, share or use your personal information in connection with a third party, we may disclose, share or use your personal information in that manner. For example, if you opt in to our social media mailing lists and promotional updates, then we may disclose your relevant personal information to social media platforms where Allied Premium Insurance, LLC has a corporate account for the purpose of adding you to Allied Premium Insurance, LLC’s social media mailing and promotional update lists. Generally in such a situation, the social media platforms are not allowed to use your personal information for their own purposes unless you have a direct account on such social media platforms, in which case your personal information would be handled by the social media platforms in accordance with the social media platforms’ privacy policies.Your Requests for ProductsIf you request to be contacted about any type of insurance product, request to be contacted by a licensed agent or other representative, request assistance with enrolling in any type of insurance product or make any other request for someone to contact you (such as by filling out an online request form), then our agents or representatives may contact you, or we may disclose your personal information to a third-party insurance agency, insurance agent, insurance company or other appropriate entity, so that such entity may contact you about any product in which you indicated interest or may assist you in enrolling in any such product. By requesting to be contacted, you expressly consent to receive e-mails, phone calls or text messages from a licensed agent or other representative at the email address and telephone number (including wireless) provided. Message and data rates will apply. While we aim to make it as easy as possible for you to talk directly with an expert, we will honor your request not be contacted further. You can easily opt-out of further communications from us by requesting to be placed on our Do Not Call list, by replying “STOP” to our text messages, or by unsubscribing from our email list. Any additional information that you subsequently choose to provide to any third-party entity will be governed by that entity’s privacy policy. Outside of these exceptions, we will not sell, trade or share your personal information with third parties.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">Legal Obligations</h4>
                <p>
                    In certain situations, Allied Premium Insurance, LLC may be required to disclose personal data in response to lawful requests by public authorities, including to meet national security or law enforcement requirements. We may also disclose your personal information as required by law, such as to comply with a subpoena, or similar legal process. We may disclose or report your personal information when we believe, in good faith, that the disclosure is required or permitted under law, for example, to cooperate with regulators or law enforcement authorities, to resolve consumer disputes, to protect our rights, to protect your safety or the safety of others, to investigate fraud, or to otherwise respond to a government request.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">Business Transition</h4>
                <p>
                    If Allied Premium Insurance, LLC is involved in a merger, acquisition, or sale of all or a portion of its assets, you will be notified via email and/or a prominent notice on our website of any change in ownership or uses of your personal information, as well as any choices you may have regarding your personal information.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">Your Consent</h4>
                <p>
                    If you provide us an indication of your consent to disclose, share or use your personal information in connection with a third party, we may disclose, share or use your personal information in that manner. For example, if you opt in to our social media mailing lists and promotional updates, then we may disclose your relevant personal information to social media platforms where Allied Premium Insurance, LLC has a corporate account for the purpose of adding you to Allied Premium Insurance, LLC’s social media mailing and promotional update lists. Generally in such a situation, the social media platforms are not allowed to use your personal information for their own purposes unless you have a direct account on such social media platforms, in which case your personal information would be handled by the social media platforms in accordance with the social media platforms’ privacy policies.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">Your Requests for Products</h4>
                <p>
                ...
                <h4 className="text-secondary font-semibold my-3 text-lg">Types of information we collect</h4>
                <p>
                ...
                <h4 className="text-secondary font-semibold my-3 text-lg">Registering With Us</h4>
                <p>
                    We begin collecting personal information from you when you register with us. You may register with us through our website by entering your email address and, if you are creating an account, choosing your password.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">
                ...
                <h4 className="text-secondary font-semibold my-3 text-lg">Third Party Data</h4>
                <p>
                ...
                <h4 className="text-secondary font-semibold my-3 text-lg">Collection and Use of 3rd party Personal Information:</h4>
                <p>
                    You may also provide personal information about other people, such as their name, date of birth and gender. This information is only used for the sole purpose of completing your request or for whatever reason it may have been provided. The third party may contact us at
                    <a href="mailto:support@apinsurancecompany.com" target="_blank" rel="noreferrer" className='mx-1 text-blue-600 hover:underline visited:text-purple-600 underline break-all'>
                        support@apinsurancecompany.com
                    </a>
                    to request that we remove this information from our database.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">Aggregate and non-directly identifying information</h4>
                <p>
                ...
                <p>We protect the confidentiality and security of your personal information.</p>
                <ul className="text-sm my-3 ml-6 list-disc">
                    <li>
                ...
                <p>We continue to evaluate our efforts to protect your personal information and make every effort to keep your personal information accurate and up to date.</p>
                <ul className="text-sm my-3 ml-6 list-disc">
                    <li>
                        Upon request Allied Premium Insurance, LLC will provide you with information about whether we hold any of your personal information. If your personal information changes, or if you otherwise want to correct, update or delete your personal information held by us, you may contact us by email at
                        <a href="mailto:support@apinsurancecompany.com" target="_blank" rel="noreferrer" className='mx-1 text-blue-600 hover:underline visited:text-purple-600 underline break-all'>
                            support@apinsurancecompany.com
                        </a>
                        or by phone at
                    ...
                    <li>
                        Additionally, you may update your name, email address and password by clicking on the “Sign in” or “My Account” link on this website and signing in using your email address and password. We will respond to your request to access within a reasonable time frame.
                    </li>
                    <li>
                        We will retain your information for as long as your account is active or as needed to provide you services. We will retain and use your information as necessary to comply with our legal obligations, resolve disputes, and enforce our agreement.
                    </li>
                    <li>
                ...
                <h4 className="text-secondary font-semibold my-3 text-lg">Changes to This Privacy Policy</h4>
                <p>We will provide notice of changes in our personal information privacy practices.</p>
                <p>If we are going to use your personal information in a manner materially different from that stated at the time of collection, we will notify you via email or by means of notice on the website prior to changes becoming effective. You will have a choice as to whether or not we use your personal information in this different manner.</p>
                <p>If we make any material changes to our privacy policy information practices that do not affect the personal information already in our database, we will notify users of the change in the privacy policy portion of our website.</p>
                <h4 className="text-secondary font-semibold my-3 text-lg">Opting Out</h4>
                <p>You may opt out of receiving satisfaction surveys and/or information on additional products and services from us.</p>
                <ul className="text-sm my-3 ml-6 list-disc">
                    <li>
                    ...
                    <li>
                        We are available to answer any questions you may have about our privacy policy or our information privacy practices. If you have any questions, please email us at
                        <a href="mailto:support@apinsurancecompany.com" target="_blank" rel="noreferrer" className='mx-1 text-blue-600 hover:underline visited:text-purple-600 underline break-all'>
                            support@apinsurancecompany.com
                        </a>
                ...
                <h4 className="text-secondary font-semibold my-3 text-lg">Websites where this policy applies</h4>
                <ul className="text-sm my-3">
                    ...
                    <li>
                        If you are returning to complete an application that you initiated on another website that is owned or operated by Allied Premium Insurance, LLC (e.g., a partner co-branded website), this privacy policy may not apply. Please review the privacy policy of the website on which you initiated your application to learn about the information privacy practices that apply to the personal information you submit to us.
                    </li>
                    <li>
                ...
                <h4 className="text-secondary font-semibold my-3 text-lg">Your Password and Other Security Issues</h4>
                <p>
                ...
                <p>
                    If you forget your password, we can send your password through email (provided that you gave us your email address as your user ID when you created an account on our website) or we can help you retrieve your password by calling us toll free at 1-888-294-9212 or contacting us through the chat function on our website.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">
                    Security Risk of Using Non-Approved Automated Software Applications
                </h4>
                <p>
                    For security reasons to guard the safety of your data, access to this website is limited to SSL-capable browsers such as recent versions of Microsoft’s Internet Explorer or Google’s Chrome. Under no circumstance should you use any software, program, application, or any other device to access or log-in to the Allied Premium Insurance, LLC website, or to automate the process of obtaining, downloading, transferring, or transmitting any content to or from our computer systems, website, or proprietary software.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">Links to Other Websites</h4>
                <p>
                    Our website contains links to other websites. Please note that when you click on one of these links you are “clicking” to another website. Allied Premium Insurance, LLC is not responsible for the information privacy practices or the content of such websites. We encourage you to read the privacy policies of these linked websites as their information privacy practices may differ from ours.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">Blog</h4>
                <p>
                    Our website offers publicly accessible blogs or community forums. You should be aware that any information you provide in these areas may be read, collected, and used by others who access them. To request removal of your personal information from our blog or community forum, contact us at
                    <a href="https://www.apinsurancecompany.com" target="_blank" rel="noreferrer" className='mx-1 text-blue-600 hover:underline visited:text-purple-600 underline break-all'>
                        www.apinsurancecompany.com
                    </a>
                ...
                <h4 className="text-secondary font-semibold my-3 text-lg">Testimonials</h4>
                <p>
                ...
                <h4 className="text-secondary font-semibold my-3 text-lg">Social Media Features and Widgets</h4>
                <p>
                ...
                <h4 className="text-secondary font-semibold my-3 text-lg">Miscellaneous</h4>
                <p>
                    We reserve the right to change this Privacy Policy at any time. We will note within the Privacy Policy when it was last updated. Any changes to this Privacy Policy will be effective as of the day they are posted. Use of our Services following these changes signifies acceptance of the revised Privacy Policy.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">Contact Us</h4>
                <p>
                    Allied Premium Insurance, LLC<br />
                    1000 Brickell Ave. STE 715<br />
                    Miami, FL 33131<br />
                    <a href="http://www.apinsurancecompany.com" className="text-blue-600 hover:underline visited:text-purple-600 underline">
                    www.apinsurancecompany.com
                    </a>
                </p>
                <p>
                ...
                <h4 className="text-secondary font-semibold my-3 text-lg">What personal information do we collect?</h4>
                <p>
                    We receive and store any information you enter on our Site or give us in any other way.  We also collect certain information automatically when you use or visit our Site.  Information we collect from visitors of our Site includes information that will be collected automatically using cookies and similar technologies.  We also collect information from you, including your name, address and email address and your phone number.  We will also collect other demographic and personal information about you, including your PHI which is protected by HIPAA.  If you choose to enroll with a health plan on our site, your PHI is transferred through the Site to the health plan you have chosen.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">How do we use your information?</h4>
                <p>
                ...
                <h4 className="text-secondary font-semibold my-3 text-lg">How do we protect your information?</h4>
                <p>
                    While no website can guarantee complete security, we use commercially reasonable efforts to protect your information, including maintaining adequate physical, procedural and technical security with respect to its offices and informational storage facilities so as to prevent any loss, misuse, unauthorized access, disclosure or modification of your information under our control.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">Do we disclose any information to outside parties?</h4>
                <p>
                    We do not sell, trade, or otherwise transfer to outside parties any of your personally identifiable information we collect from you during visit to the Site except for the transfer to the health plan that you have chosen. We may share your information for processing and storage with third parties that have agreements in place with us to protect the confidentiality and security of information that we transfer to them.  This may include our development partners and third parties where the services are hosted.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">How do we store and encrypt your data?</h4>
                <p>
                    None of your data is stored on a device. Your data is stored at secure locations that use encryption to protect your data when stored on these computer servers or when storing it with a third party. Your data is also encrypted while it is being transmitted.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">Access to other data</h4>
                <p>
                    None of our technologies will request access to other device data or applications, such as your phone’s camera, photos or contacts. None of our technologies share any data with your social media accounts, like Facebook.
                </p>
                <h2 className="font-semibold text-2xl my-4">Children’s Privacy</h2>
                <p>
                    This website is not intended for use by children under the age of 18. We encourage parents to supervise their children’s activities online. Enhance does not seek or knowingly collect personal information from children under the age of 13. If we learn that we have received information directly from a child who is under the age of 13, we will take appropriate action in accordance with applicable law.
                </p>
                <h4 className="text-secondary font-semibold my-3 text-lg">Contact Us</h4>
                <p>
